    ...
    <div className="h-screen w-full bg-gray-900 flex flex-col overflow-hidden text-white font-sans">
      <header className="w-full p-4 flex items-center justify-between border-b border-gray-800 bg-gray-900/90 backdrop-blur z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="text-gray-400 text-sm bg-gray-800 px-3 py-1 rounded border border-gray-700 ml-2 inline-flex items-center cursor-pointer hover:bg-gray-700" onClick={copyRoomCode}>
            Code: {roomId} <Info size={14} className="ml-2" />
          </span>
          {shouldShowHostControls && (
            <button
              onClick={copyInviteLink}
              className="text-gray-300 text-sm bg-blue-950/70 px-3 py-1 rounded border border-blue-800 inline-flex items-center gap-2 hover:bg-blue-900/70 max-w-[420px]"
              title={inviteLink}
            >
        ...
        {isChatOpen && (
          <aside className="fixed inset-y-0 right-0 z-20 w-80 bg-gray-800 border-l border-gray-700 flex flex-col shadow-2xl md:relative md:rounded-xl md:my-2 md:mr-2">
            <div className="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-800 rounded-t-xl">
              ...
              <button className="text-gray-400 hover:text-white md:hidden" onClick={() => setIsChatOpen(false)}><X size={18} /></button>
            </div>
        ...
        {isPeopleOpen && (
          <aside className="fixed inset-y-0 right-0 z-20 w-80 bg-gray-800 border-l border-gray-700 flex flex-col shadow-2xl md:relative md:rounded-xl md:my-2 md:mr-2">
            <div className="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-800 rounded-t-xl">
              ...
              <button className="text-gray-400 hover:text-white md:hidden" onClick={() => setIsPeopleOpen(false)}><X size={18} /></button>
            </div>
